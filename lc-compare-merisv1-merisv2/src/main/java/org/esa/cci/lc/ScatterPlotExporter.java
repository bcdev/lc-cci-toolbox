...
//        domain axis is the X axis
    ...
    public void export(float[][] scatter, float[] line, String scatterplotTitle, String xAxisLabel, String yAxisLabel, File file,
                       String surfaceType) throws IOException {
        XYDataset dataset = createDataset(scatter, line);
        saveChart(scatterplotTitle, xAxisLabel, yAxisLabel,
    ...
    private void saveChart(String title, String xAxisLabel, String yAxisLabel, XYDataset dataset, float[] lineParam,
        ...
        String label2 = String.format("residual = %4.3f", lineParam[2]);
        String label3 = String.format("number = %4.0f (%s)", lineParam[4], surfaceType);
        XYTextAnnotation annotation1 = createLineAnnotation(0.2, 0.95, label1);
        XYTextAnnotation annotation2 = createLineAnnotation(0.2, 0.90, label2);
        XYTextAnnotation annotation3 = createLineAnnotation(0.2, 0.85, label3);
