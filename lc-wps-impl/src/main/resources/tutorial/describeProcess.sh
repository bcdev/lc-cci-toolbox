...
wget -q --user=$WPS_USER --ask-password -O- "www.brockmann-consult.de/bc-wps/wps/lc-cci?Service=WPS&Request=DescribeProcess&Version=1.0.0&Identifier=${PROCESS_ID}"
